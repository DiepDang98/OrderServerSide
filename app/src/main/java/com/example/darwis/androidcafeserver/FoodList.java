package com.example.darwis.androidcafeserver;
...
import com.example.darwis.androidcafeserver.Model.Food;
import com.example.darwis.androidcafeserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                if (newFood != null) {
                    ...
                    Snackbar.make(rootLayout, "Menu" + newFood.getName() + " đã thêm", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void showUpdateFoodDialog(final String key, final Food item) {
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                Snackbar.make(rootLayout, "Món" + item.getName() + " đã cập nhật", Snackbar.LENGTH_SHORT).show();
    ...
    private void changeImage(final Food item) {
        if (saveUri != null) {
            ...
            imageFolder.putFile(saveUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    mDialog.dismiss();
                    Toast.makeText(FoodList.this, "Đã cập nhật!!!", Toast.LENGTH_SHORT).show();
                    imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                            //set value for newCategory if image upload and we can get download link
